"""
Sistema de Monitoramento Solar - Versão Simplificada
"""
...
app = FastAPI(
    ...
    description="Monitoramento de placas solares - Versão Demo",
    version="1.0.0"
)
        ...
        <body>
            <div class="container">
                ...
                <div class="info">
                    ...
                    <ul>
                        <li><strong>API REST:</strong> <a href="/docs" style="color: white;">/docs</a> - Documentação completa</li>
                        <li><strong>Status do Sistema:</strong> <a href="/health" style="color: white;">/health</a> - Verificação de saúde</li>
                        <li><strong>Configuração:</strong> <a href="/config" style="color: white;">/config</a> - Configurar equipamentos</li>
                        <li><strong>Dados do Inversor:</strong> <a href="/api/v1/inverters/1/status" style="color: white;">/api/v1/inverters/1/status</a></li>
                        <li><strong>Alertas:</strong> <a href="/api/v1/alerts/active" style="color: white;">/api/v1/alerts/active</a></li>
                    </ul>
                </div>
                ...
                <div class="warning">
                    ...
                    <ol>
                        <li>Acesse a página de <a href="/config" style="color: white;">Configuração</a></li>
...
async def health_check():
    ...
    return {
        ...
        "services": {
            "api": True,
            "database": False,  # Será habilitado quando configurado
            "modbus": False     # Será habilitado quando configurado
        },
        "message": "Sistema funcionando - Configure os IPs dos equipamentos para ativação completa"
    }
...
async def inverter_status():
    ...
    return {
        ...
        "current_power": 2450.5,
        "daily_energy": 18.7,
        "temperature": 45.2,
        "efficiency": 89.5,
        "status_code": 1,
        "fault_code": 0,
        "message": "Dados simulados - Configure Modbus para dados reais"
    }
    ...
    return [
        {
            ...
            "severity": "low",
            "message": "Sistema iniciado - Configure conexão Modbus",
            "timestamp": datetime.now().isoformat(),
            "acknowledged": False,
            "resolved": False
        }
...
async def system_status():
    ...
    return {
        ...
        "uptime": "calculando...",
        "message": "Configure os IPs dos equipamentos no arquivo .env"
    }
...
async def get_config():
    ...
    try:
        ...
        return {
            ...
            "application": {
                "data_collection_interval": int(config.get("DATA_COLLECTION_INTERVAL", "60"))
            },
            "alerts": {
                "connection_timeout_threshold": int(config.get("CONNECTION_TIMEOUT_THRESHOLD", "5"))
            }
        }
...
async def save_config(config_data: dict):
    ...
    try:
        ...
        current_config.update({
            ...
            "DATA_COLLECTION_INTERVAL": str(config_data.get("collection_interval", 60)),
            "CONNECTION_TIMEOUT_THRESHOLD": str(config_data.get("connection_timeout", 5))
        })
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("Configure os IPs dos equipamentos no arquivo .env")
    print("Execute 'python test_connection.py' para testar conectividade")
    print("Execute 'python demo_data.py' para dados de demonstração")
    print()
